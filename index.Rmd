...
readr::write_csv(data_long, path = here::here("data", "wrangled_data.csv"))
```
...
readr::write_csv(wide_US, path = here::here("data", "wrangled_US_data.csv"))
```
...
```{r, echo = FALSE}
load(here::here("data", "wrangled_US_data.rda"))
